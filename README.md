...
*(update this link after you deploy — see "Deploying" below)*
...
demo at [john-guerra/Airbnb_Listings_demo_page](https://github.com/john-guerra/Airbnb_Listings_demo_page)
...
just another display of it — you can build out "night 1, night 2, night 3"
...
4. Save. GitHub will publish the site at
   ...
   minute or two.
5. Update the "Live site" link at the top of this README with that URL.
...
- No external JS framework or CSS framework is used — vanilla `fetch`,
